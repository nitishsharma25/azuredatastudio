...
suite('NotebookViews', function (): void {
	...
	async function initializeExtension(): Promise<NotebookViewsExtension> {
		...
		let model = new NotebookModel(defaultModelOptions, undefined, logService, notificationService.object, new NullAdsTelemetryService(), queryConnectionService.object, configurationService, undoRedoService, mockNotebookService.object, capabilitiesService.object, undefined);
